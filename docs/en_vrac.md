...
* Alinsky, Saul
  * _Manuel de l'animateur social// -- [[http:_www.naje.asso.fr/article.php3?id_article=333|Lire en ligne]]
...
* Bakounine, Michel
  * _Dieu et l'État_
  * _Marxism, Freedom and the State// [[http:_dwardmac.pitzer.edu/anarchist_archives/bakunin/marxnfree.html|Lire en ligne]]
...
* Begout, Bruce
  * _De la décence ordinaire_ (via @belladonnne)
...
* (De La) Boetie, Etienne
  * _Le Discours de la servitude volontaire_ (via @lentremetteur)

* Bordas, Nicolas
  * L'idée qui tue ! : Politique, business, culture... Les secrets des idées qui durent

* Brossat Alain
  * _Tous coupat tous coupables_ (via @JoujouDemocratique) [antiviolence, democratie, domination]
...
* Castoriadis Cornélius
  ...
  * _Les carrefours du labyrinthe, Tome 5 : Fait et à faire _
...
## F 
  ...
  * **[[http://fr.wikipedia.org/wiki/Michel_Foucault|Foucault, Michel]]**
...
## G 
  ...
  * Gille, Bertrand
    * Histoire des techniques : \\ //« L'adoption d'un système technique entraîne nécessairement l'adoption d'un système social correspondant, an que ses cohérences soient maintenues... pour qu'un nouveau système technique s'impose, il doit entraîner nécessairement d'inévitables adaptations sociales. Dès le 
Moyen Âge, les corporations ont refusé... maintes techniques nouvelles susceptibles de détruire une organisation préétablie... Si l'on sait que les systèmes sociaux sont particulièrement rigides, on comprendra aisément combien la
cohérence entre ces deux ordres de systèmes est dificile à établir 3. »//
  ...
  * Graeber, David
    * [[http:_www.editionslesliensquiliberent.fr/f/index.php?sp=liv&livre_id=73|Dette : 5000 ans d'histoire]], [Anthropologie & sociologie]. \\ Commentaire sur [[http://merome.net/blog/index.php?post/2014/05/31/Dette-%3A-5000-ans-d-histoire|Merome]] et [[http:_www.editionslesliensquiliberent.fr/f/index.php?sp=liv&livre_id=73|Editions Les Liens Qui Libèrent]]

  * Gramsci, Antonio
    * Lettres de prison (1926-1934) [[http://www.jutier.net/contenu/agramsci.htm|Lire en ligne]]
  ...
  * Guérin, Daniel 
    ...
    * histoire de l'anarchisme, communisme libertaire, etc. (via Gilles Châtelet)
...
<!--
  * Houellebecq, Michel
    * _Contre le monde, contre la vie_, essai sur Lovecraft
...
## K 
  ...
  * Kant, Emmanuel
    * _Idée d'une histoire universelle d'un point de vue cosmopolitique_ \\ (via Emile Pennes) \\ ( court et incroyablement percutant)

  * Keynes, John Maynard
    * Théorie générale de l'emploi, de l'intérêt et de la monnaie. (1936) [[http://www.jutier.net/contenu/jmkey1.htm|Lire en ligne]]
...
<!--
  * Kundera, Milan
    * _L'insoutenable légèreté de l'être_ (1984)
-->

## L 

  * Lafargue, Paul
    * _Le droit à la paresse. Réfutation du droit au travail de 1848// (1883) [[http:_www.jutier.net/contenu/paresse.htm|Lire en ligne]]
    * _La religion du Capital (1887)// [[http:_www.jutier.net/contenu/plafrc.htm|Lire en ligne]]
  ...
  * Lenine
    ...
    * _L'Etat et la Révolution _

  * Lippman, Walter
    * _Public Opinion_ (via Gilles Châtelet)
  ...
  * Luxemburg, Rosa 
    * Introduction à l'économie politique (1925) [[http://www.jutier.net/contenu/rosalux.htm|Lire en ligne]]

## M 

  * Machiavel, Nicolas
    * _Le Prince (1515)// [[http:_www.jutier.net/contenu/nmachlp.htm|Lire en ligne]]
  ...
  * Malthus, Thomas-Robert (1766-1834) 
    * _Essai sur le principe de population// (1798) [[http:_www.jutier.net/contenu/prinpopu.htm|Lire en ligne]]
  ...
  * Mauss, Marcel (1872-1950)
    * _Manuel d'ethnographie// (1926) [[http:_www.jutier.net/contenu/mma1.htm|Lire en ligne]]
    * _Les origines de la notion de monnaie// (1914) [[http:_www.jutier.net/contenu/marmaus1.htm|Lire en ligne]]
  ...
  * More, Thomas, (1478-1535)
    * _L'utopie ou Le Traité de la meilleure forme de gouvernement// (1516) [[http:_www.jutier.net/contenu/utopietm.htm|Lire en ligne]]
...
## P 
  ...
  * Jean-Claude Perrot 
    * _Une histoire intellectuelle de l´économie politique_ (via Gilles Châtelet)
...
## R 
  ...
  * **Ricoeur, Paul** (PHI) http://fr.wikipedia.org/wiki/Paul_Ric%C5%93ur
...
## S 
  ...
  * San Giorgio, Piero
    * _Survivre à l'effondrement économique_ (via Virginie Beernaert)
  ...
  * Sussan, Rémi
    * _Les utopies posthumaines// - http:_www.omniscience.fr/collections/Collection-Essais-2/Les-utopies-posthumaines-1.html
...
## T 
  ...
  * [[http://fr.wikipedia.org/wiki/Emmanuel_Todd|Todd, Emmanuel]]
  ...
  * Trotsky, Léon
    * La révolution permanente (1928-1931) [[http://www.jutier.net/contenu/trot0.htm|Lire en ligne]]

  * [[http://en.wikipedia.org/wiki/Benjamin_Tucker|Tucker, Benjamin]]
    * _Instead of a Book, by a Man Too Busy to Write One// (1893, 1897) [[http:_fair-use.org/benjamin-tucker/instead-of-a-book/|Lire en ligne]]
...
## V 
  ...
  * [[http://fr.wikipedia.org/wiki/Paul_Virilio|Virilio, Paul]]
...
## W 
  ...
  * [Wilber, Ken](http://fr.wikipedia.org/wiki/Ken_Wilber)
    * _A Theory of Everything: An Integral Vision for Business, Politics, Science and Spirituality_ (2000) (ISBN 0-71713-163-7)
...
## Y 
  ...
  * Yamamoto, Jōchō
    * _[[http://fr.wikipedia.org/wiki/Hagakure|Hagakure]]_
...
## _ 
  ...
  * Mattelart, Armand et Vitalis, André
    * _Le profilage des populations, du livret ouvrier au cybercontrole_

  * La Piste Rouge - Italia 1969 -1972".

  * _L'Appel des appels, pour une insurrection des consciences_, Sous la direction de Roland Gori, Barbara Cassin et Christian Laval 

  * _Le populisme aujourd'hui_, Joël Gaubert, Jean-Claude Pinson, Maryse Souchard , Jean-Michel Vienne 
  ...
  * _Sun Tzu, L'art de la guerre_

  * _Le livre des Ruses_ (Ed. Phébus libretto)

  * _Les 36 Stratagèmes, Manuel secret de l'art de la guerre_

  * _Eloge de la désobeissance civile_

  * Les Désobéissants
    * _Désobeir à la PUB_

  * _Agir local penser global_

  * _Ne sauvons pas le système qui nous broie_

  * _L'insurrection qui vient_

  * _Le petit livre rouge de mai 68_

  * _Le cumul des droits intellectuels// \\ Sous la direction de : Alexandre Cruquenaire, Séverine Dusollier \\ http:_editions.larcier.com/livre/?GCOI=28044100889870
